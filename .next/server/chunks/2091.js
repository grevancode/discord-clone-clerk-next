...
var dist = __webpack_require__(24007);
...
var react_dist = __webpack_require__(8912);
...
function FileUpload({ onChange, value, endpoint }) {
...
function InviteModal() {
    const { isOpen, onOpen, onClose, type, data } = (0,use_modal_store/* useModal */.d)();
...
const edit_server_modal_formSchema = lib/* object */.Ry({
    name: lib/* string */.Z_().min(1, {
        message: "Server name is required."
    }),
    imageUrl: lib/* string */.Z_().min(1, {
...
function EditServerModal() {
    ...
    const { server } = data;
    const form = (0,index_esm/* useForm */.cI)({
        resolver: (0,zod/* zodResolver */.F)(edit_server_modal_formSchema),
        defaultValues: {
            name: "",
            imageUrl: ""
        }
...
const create_channel_modal_formSchema = lib/* object */.Ry({
    ...
    type: lib/* nativeEnum */.jb(client_default.ChannelType)
});
function CreateChannelModal() {
    ...
    const form = (0,index_esm/* useForm */.cI)({
        ...
        defaultValues: {
            name: "",
            type: channelType || client_default.ChannelType.TEXT
        }
    });
    (0,react_.useEffect)(()=>{
        if (channelType) {
            ...
            form.setValue("type", client_default.ChannelType.TEXT);
        }
    }, [
        channelType,
        form
                                                    ...
                                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(Select, {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ jsx_runtime_.jsx(SelectContent, {
                                                                children: Object.values(client_default.ChannelType).map((type)=>/*#__PURE__*/ jsx_runtime_.jsx(SelectItem, {
                                                                        value: type,
...
function EditChannelModal() {
    ...
    const form = (0,index_esm/* useForm */.cI)({
        ...
        defaultValues: {
            name: "",
            type: channel?.type || client_default.ChannelType.TEXT
        }
    });
    (0,react_.useEffect)(()=>{
        if (channel) {
...
function MessageFileModal() {
    const { isOpen, onClose, type, data: { apiUrl, query } } = (0,use_modal_store/* useModal */.d)();
    const router = (0,navigation.useRouter)();
...
function SocketProvider({ children }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        const socketInstance = new socket_io_client__WEBPACK_IMPORTED_MODULE_2__.io("http://localhost:3000", {
            path: "/api/socket/io",
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_ui_avatar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(59943);
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12857);
...
function UserAvatar({ src, className }) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_avatar__WEBPACK_IMPORTED_MODULE_2__.Avatar, {
        className: (0,_lib_utils__WEBPACK_IMPORTED_MODULE_3__.cn)("h-7 w-7 md:h-10 md:w-10", className),
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_avatar__WEBPACK_IMPORTED_MODULE_2__.AvatarImage, {
            src: src
        })
    });
}
...
// EXTERNAL MODULE: external "next/dist/compiled/react/jsx-runtime"
var jsx_runtime_ = __webpack_require__(56786);
// EXTERNAL MODULE: ./node_modules/next/font/google/target.css?{"path":"app\\layout.tsx","import":"Open_Sans","arguments":[{"subsets":["latin"]}],"variableName":"openSans"}
var target_path_app_layout_tsx_import_Open_Sans_arguments_subsets_latin_variableName_openSans_ = __webpack_require__(2696);
var target_path_app_layout_tsx_import_Open_Sans_arguments_subsets_latin_variableName_openSans_default = /*#__PURE__*/__webpack_require__.n(target_path_app_layout_tsx_import_Open_Sans_arguments_subsets_latin_variableName_openSans_);
...
const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\providers\theme-provider.tsx`)
...
const modal_provider_proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\providers\modal-provider.tsx`)
...
const socket_provider_proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\providers\socket-provider.tsx`)
...
const query_provider_proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\providers\query-provider.tsx`)
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(esm/* ClerkProvider */.El, {
        children: /*#__PURE__*/ jsx_runtime_.jsx("html", {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx("body", {
                className: (0,utils.cn)((target_path_app_layout_tsx_import_Open_Sans_arguments_subsets_latin_variableName_openSans_default()).className, "bg-white dark:bg-[#313338]"),
