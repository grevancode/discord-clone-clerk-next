...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 26163));
...
function ChatWelcome({ name, type }) {
...
function ChatItem({ id, content, member, timestamp, fileUrl, deleted, currentMember, isUpdated, socketUrl, socketQuery }) {
    ...
    const isAdmin = currentMember.role === client_default.MemberRole.ADMIN;
    const isModerator = currentMember.role === client_default.MemberRole.MODERATOR;
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "group flex gap-x-2 items-center w-full",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            ...
                            !fileUrl && !isEditing && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                                className: (0,utils.cn)("text-sm text-zinc-600 dark:text-zinc-300", deleted && "italic to-zinc-500 dark:text-zinc-400 text-xs mt-1"),
                                children: [
                                    content,
...
function ChatMessages({ name, member, chatId, apiUrl, socketUrl, socketQuery, paramKey, paramValue, type }) {
    ...
    if (status === "loading") return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
    ...
    if (status === "error") return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "flex flex-col flex-1 justify-center items-center",
        children: [
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: data?.pages.map((group, index)=>/*#__PURE__*/ jsx_runtime_.jsx(react_.Fragment, {
...
/* harmony import */ var query_string__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(47339);
...
function ChatVideoButton() {
    ...
    const Icon = isVideo ? lucide_react__WEBPACK_IMPORTED_MODULE_5__/* .VideoOff */ .pYS : lucide_react__WEBPACK_IMPORTED_MODULE_5__/* .Video */ .nkn;
    const tooltipLabel = isVideo ? "End video call" : "Start video call";
    const onClick = ()=>{
        const url = query_string__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z.stringifyUrl({
            url: pathName || "",
            query: {
...
function MediaRoom({ chatId, video, audio }) {
    ...
    if (token === "") return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: "flex flex-col flex-1 justify-center items-center",
        children: [
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_livekit_components_react__WEBPACK_IMPORTED_MODULE_5__/* .LiveKitRoom */ .IC, {
        ...
        token: token,
        connect: true,
        serverUrl: "wss://capydiscord-nq2n5ji2.livekit.cloud/",
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  SocketIndicatior: () => (/* binding */ SocketIndicatior)
});
...
;// CONCATENATED MODULE: ./components/socket-indicatior.tsx
/* __next_internal_client_entry_do_not_use__ SocketIndicatior auto */ 



function SocketIndicatior() {
    const { isConnected } = (0,socket_provider.useSocket)();
    if (!isConnected) return /*#__PURE__*/ jsx_runtime_.jsx(Badge, {
        variant: "outline",
...
const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\ui\sheet.tsx`)
...
const avatar_proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\ui\avatar.tsx`)
...
const socket_indicatior_proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\socket-indicatior.tsx`)

// Accessing the __esModule property and exporting $$typeof are required here.
// The __esModule getter forces the proxy target to create the default export
// and the $$typeof value is for rendering logic to determine if the module
// is a client boundary.
const { __esModule: socket_indicatior_esModule, $$typeof: socket_indicatior_$$typeof } = socket_indicatior_proxy;
const socket_indicatior_default_ = socket_indicatior_proxy.default;

const socket_indicatior_e0 = socket_indicatior_proxy["SocketIndicatior"];

;// CONCATENATED MODULE: ./components/chat/chat-video-button.tsx

const chat_video_button_proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\chat\chat-video-button.tsx`)
...
function ChatHeader({ name, serverId, type, imageUrl }) {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(socket_indicatior_e0, {})
                ]
            })
        ]
    });
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\chat\chat-input.tsx`)
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\chat\chat-messages.tsx`)
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\devak\Downloads\discord-clone-master\discord-clone-master\components\media-room.tsx`)
